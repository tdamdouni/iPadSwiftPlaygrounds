...
public class Graphic: MessageControl {
    ...
    /// Scales the node over duration in seconds.
    ...
    /// Animates the graphic to fade in to the scene after the provided number of seconds.
    ...
    public func moveAndZap(to position: Point, duration: Number = 0.25) {
        Message.moveAndZap(id: id, position: CGPoint(position), duration: duration.double).send()
