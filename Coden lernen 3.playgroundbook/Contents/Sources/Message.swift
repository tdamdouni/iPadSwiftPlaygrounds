...
public indirect enum Message: RawRepresentable {
    ...
    case moveAndZap(id: String, position: CGPoint, duration: Double)
    case spinAndPop(id: String, after: Double)
    ...
    public init?(rawValue: RawValue) {
        ...
        case .moveAndZap:
            if
                ...
                self = .moveAndZap(id: id, position: position, duration: duration)
                return
            }
        ...
        case .spinAndPop:
            if
                let id = decoder.id,
                let duration = decoder.duration {
                self = .spinAndPop(id: id, after: duration)
                return
            }
