...
viewController.assessment = (averageTurnCount: 75, passMessage: "Well done! You've made great improvements to your algorithm! When you're ready, move on to the next page to improve how you locate ships.")
