...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.didUseForLoop || checker.didUseWhileLoop {
        ...
        success = " ### Congrats! \nYou solved the puzzle, but you used \(checker.calledFunctions.count) commands! Try defining your own [function](glossary://function) using `func name() {}`, and call it to solve the puzzle. You won't need to use as many commands, and your code will be easier to read. You can also move on if you'd like. [Next Page](@next)"
