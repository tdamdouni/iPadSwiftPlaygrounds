...
var hints = [
    ...
    if world.commandQueue.containsIncorrectToggleCommand() {
        hints[0] = "Before you toggle the switch, move Byte to the switch tile at the top of the second staircase."
    }
    ...
    if checker.functionCallCount(forName: "collectGem") == 0 {
        ...
        hints[0] = "After you've collected the gem, move Byte to the switch (the tile at the top of the second staircase). Then use `toggleSwitch()` to turn it on."
