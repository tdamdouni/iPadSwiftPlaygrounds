 ...
 **Goal:** Use a for loop to repeat a sequence of commands.
 ...
 In this puzzle, Byte must collect four gems that are located in the same relative locations around a square. You’ll create a [loop](glossary://loop) that repeats the code below for each of the sides to solve the entire puzzle.
