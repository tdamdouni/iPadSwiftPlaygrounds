...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.calledFunctions == defaultContents {
        ...
        hints[0] = NSLocalizedString("Adding more commands might not help here. Try rearranging your existing code by tapping on a command to select it, then dragging it to a new location.", comment:"Hint")
