 ...
 **Goal** Handle collisions.
 ...
 You can make the game unpredictable by using the function `randomInt(from:to:)`, which generates a random integer using values that you pass in. Use your imagination and see what you can create!
