...
public class GameViewController: UIViewController {
    ...
    public var game = Game() {
        didSet {
            ...
            if game.selectableActions.count == 0 {
    ...
    private func setupViews() {
        ...
        #if DEBUG
            contentLayoutGuide.topAnchor.constraint(equalTo: view.topAnchor).isActive = true
    ...
    private func setupBotPlayers() {
        ...
        for (index, player) in game.opponents.enumerated() {
            ...
            if index == 0 {
                ...
                let botToHumanSpacerMultiplier: CGFloat = 1.5
                ...
                botToHumanSpacerLayoutGuide.heightAnchor.constraint(equalTo: firstBotPlayerView.heightAnchor, multiplier: botToHumanSpacerMultiplier).isActive = true
                ...
                if let botLowerSpacerLayoutGuide = botLowerSpacerLayoutGuide {
                    ...
                    botLowerSpacerLayoutGuide.heightAnchor.constraint(equalTo: botReadyLayoutGuide.heightAnchor, multiplier: botToHumanSpacerMultiplier - lowerSpacerMultiplierOffset).isActive = true
                }
            ...
            if isBotPlayerLayoutLower(atIndex: index) && botLowerSpacerLayoutGuide != nil {
    ...
    private func positionPlayers(animated: Bool) {
        ...
        UIView.animate(withDuration: 0.5) {
            for playerViewController in self.playerViewControllers where playerViewController.player.type == .bot {
                playerViewController.view.alpha = self.status == .ready ? 0 : 1
            }
        }
