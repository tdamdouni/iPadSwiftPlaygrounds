...
public class AudioPlayerEngine {
    ...
    private let stateChangeQueue = DispatchQueue(label: "AudioPlayerEngine.StateQueue", attributes: .serial, target: nil)
    ...
    init(frameCount: AVAudioFrameCount, tap: AVAudioNodeTapBlock) {
        self.tap = tap
