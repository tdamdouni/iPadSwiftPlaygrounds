...
let hints = [
"First, add two coordinates to `blockLocations`, one for each remaining corner of the puzzle world. Use the following [syntax](glossary://syntax):\n\n```swift\nvar corners = [\n    Coordinate(column: 0, row: 0),\n    Coordinate(column: 3, row: 3)\n]\n",
"After you add coordinates to your array, [iterate](glossary://iteration) over each coordinate in the array, placing `5` blocks at each coordinate. You may want to write an additional [`for` loop](glossary://for%20loop) inside your `for-in` loop:\n\n```swift\nfor coordinate in blockLocations {\n    for i in 1...5 {\n        place a block\n    }\n}\n"
]
