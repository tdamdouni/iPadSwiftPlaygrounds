...
let hints = [
    "First, you need to set the `isActive` [property](glossary://property) of `greenPortal` to `false`. Otherwise, every time you try to reach a switch, your character will teleport away.",
