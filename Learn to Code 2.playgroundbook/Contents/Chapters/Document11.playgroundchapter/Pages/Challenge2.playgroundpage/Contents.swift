...
//#-end-hidden-code
/*:
**Challenge:** Solve this puzzle using your knowledge of initialization, [parameters](glossary://parameter), and other skills in your coding tool belt.
 ...
 Remember how [types](glossary://type) are just blueprints for instances? You can [initialize](glossary://initialization) two instances of the same type. They’re basically identical, but you control them separately.
*/
