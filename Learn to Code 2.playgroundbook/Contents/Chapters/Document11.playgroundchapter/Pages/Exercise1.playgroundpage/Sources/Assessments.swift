...
let hints = [
    ...
    "After you write your `move` function, call it and pass in an [argument](glossary://argument) to move your character forward by the number of tiles defined for `distance`. For example, `move(distance: 5)` will move your character forward 5 tiles."
]
