...
public func assessmentPoint() -> AssessmentResults {
    ...
    let hints = [
        "Add a condition to your [`while` loop](glossary://while%20loop) to run a block of code as long as that condition is true.",
        "Here's one approach: while your character is on a closed switch, toggle that switch and move on to the next one."
    ]
