...
/**
 All instances of gems, switches, portals, blocks, characters, and experts are of the type `Item`. This allows you to use these instances in methods such as `place(item:at:)` and `removeItems(at:)`.
 */
