...
func placeBlocks() {
    world.removeItems(at: world.coordinates(inColumns: [4,5,6], intersectingRows: [2,3,5,6]))
    world.placeWater(at: world.coordinates(inColumns: [4,5,6], intersectingRows: [2,3,5,6]))
    
    world.removeItems(at: world.coordinates(inColumns: [6], intersectingRows: [0,1]))
    world.placeWater(at: world.coordinates(inColumns: [6], intersectingRows: [0,1]))
    
    world.removeItems(at: world.coordinates(inColumns: [0,1,2,3], intersectingRows: [5]))
    world.placeWater(at: world.coordinates(inColumns: [0,1,2,3], intersectingRows: [5]))
    
    world.removeItems(at: world.coordinates(inColumns: [4,5], intersectingRows: [0]))
    ...
    world.removeItems(at: world.coordinates(inColumns: [2,3], intersectingRows: [3]))
