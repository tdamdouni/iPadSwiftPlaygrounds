...
func placeBlocks() {
    ...
    world.removeItems(at: world.coordinates(inColumns: [3,4,5], intersectingRows: [3,4,5]))
    
    world.removeItems(at: world.coordinates(inColumns: [1,2], intersectingRows: [4,5]))
    world.removeItems(at: world.coordinates(inColumns: [4,5], intersectingRows: [1,2]))
