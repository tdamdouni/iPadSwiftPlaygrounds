...
let hints = [
    NSLocalizedString("You can use the the following code to create an [instance](glossary://instance) of type `Stair` and place it at the same time: `world.place(Stair(), facing: east, atColumn: 3, row: 3)`.", comment:"Hint"),
