...
/*:
 The shape you're creating is called a [hypotrochoid](https://en.wikipedia.org/wiki/Hypotrochoid). Although it's similar to the cycloids you've already drawn, because of the spoke flexibility, the shapes you can create are very different.
 
 **Note:** Because [trochoids](glossary://trochoid) are *more flexible* than cycloids, you can think of cycloids as a [subset](glossary://subset) of trochoids. Think of how a square is a specific kind of rectangle, and a rectangle is a specific kind of quadrilateral. In the same way, a cycloid is a specific kind of trochoid, and a trochoid is a specific kind of roulette!
 */
